      ...
      <div className="site-container py-14 grid md:grid-cols-2 gap-8 items-center">
        <div>
          <h3 className="text-4xl md:text-5xl font-extrabold text-white">
            Engage with Us in <span className="text-[var(--accent)]">Conversation</span>.
          </h3>
      ...
      <div className="site-container pb-10 text-blue-200 text-sm grid md:grid-cols-4 gap-6">
        <div>
          ...
          <ul className="space-y-2 opacity-80">
            <li className="hover:text-[var(--accent)] cursor-pointer transition-colors">Our Story</li>
            <li className="hover:text-[var(--accent)] cursor-pointer transition-colors">Store Locator</li>
            <li className="hover:text-[var(--accent)] cursor-pointer transition-colors">Sustainability</li>
            <li className="hover:text-[var(--accent)] cursor-pointer transition-colors">Careers</li>
          </ul>
        </div>
        <div>
          <div className="text-white font-semibold mb-3">Customer Service</div>
          <ul className="space-y-2 opacity-80">
            <li className="hover:text-[var(--accent)] cursor-pointer transition-colors">Prices and Payments</li>
            <li className="hover:text-[var(--accent)] cursor-pointer transition-colors">Shipping</li>
            <li className="hover:text-[var(--accent)] cursor-pointer transition-colors">Return Policy</li>
        ...
        <div className="flex items-end md:items-center justify-end">
          <div className="text-3xl md:text-5xl font-extrabold text-white">
            Poli<span className="text-[var(--accent)]">form</span>
          </div>
        </div>
      </div>
    </footer>
